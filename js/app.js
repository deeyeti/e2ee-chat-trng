...
class App {
  ...
  async _runTRNG() {
    ...
    this._trng.addEventListener('complete', async (e) => {
      ...
      // Sensor capture supports progress/auditing only. Session keys are
      // generated by Web Crypto and derived from shared ECDH material.
      entropy.fill(0);
  ...
  async _runKeyExchange() {
    ...
    try {
      // Generate an ephemeral ECDH key pair with the browser CSPRNG.
      this._myPublicKey = await this._crypto.generateKeyPair();
